...
export const RULES_TEXT = {
  ...
  icecream: {
    ...
    details: [
      ...
      `YOUR BOT SEES — each day: the 8-day forecast market (forecast high ± error and rain odds per day, plus every contract price), the calendar (weekend/holiday), its current positions and reserves, days-until-billing, the full history so far, and 5 years of training data. It returns the target portfolio — how many of each contract to hold. Build anything within reason.`,
    ].join("\n"),
  },
};
