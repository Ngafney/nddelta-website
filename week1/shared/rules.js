...
export const RULES_TEXT = {
  ...
  icecream: {
    simple: [
      `You run Sunset Scoops, an ice cream shop. Sales swing hard with the weather — a warm dry day takes about $2,400, a cold one about $1,500, and rain is worse. Costs are $${ICE.dailyCost.toLocaleString()} EVERY day, rain or shine.`,
    ...
    details: [
      ...
      `HOW A CONTRACT ACTUALLY PAYS — say "under_70@5" (the high is under 70°, five days out) is priced at $0.30. You hold 900 of them. If that day really does come in under 70°, the price walks to $1.00 and you make 900 × (1.00 − 0.30) = +$630 — which lands right when a cold day guts your sales. If it comes in warm, the price walks to $0 and you lose 900 × $0.30 = $270 on a day you were making money anyway. That is what a hedge IS: you give up a little on good days to be rescued on bad ones.`,
      `WHY SIZE AND TIMING ARE THE WHOLE PUZZLE — in this data a cold day (under 70°) earns about $900 LESS than a warm one, and a rainy day about $800 less, so a hedge of a few hundred contracts barely moves the needle and thousands over-corrects. Timing matters just as much: tomorrow's forecast is accurate, so tomorrow's contract is already priced near $0 or $1 and transfers almost no risk. The risk you can actually offload sits FURTHER OUT, where the forecast is still uncertain and prices are still near the middle. Buying several days ahead and holding through settlement is what really protects the shop.`,
      `THE TWO BOARDS REWARD DIFFERENT THINGS — buying early and holding is what prevents bankruptcies (it can cut them by more than half), but carrying positions for days adds day-to-day swings, which costs you Sharpe. Light, precise, close-in hedging keeps Sharpe high but saves you less often. Decide which board you're playing for; you probably can't top both.`,
